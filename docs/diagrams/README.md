...
| ファイル | 図 | 正本の節 |
|---|---|---|
| [architecture.md](architecture.md) | システムアーキテクチャ（カスケード＋監査ループ＋taxonomy / rulebook 単一ソース＋tracker fan-out） | design.md §1, §3, §4 |
...
| 01 全体像 | architecture 図（※ボード上は taxonomy 追加前の旧版。再生成が未実施） |
| 02 進め方 | milestones 図 |
